...
if (pkg.version !== "0.9.13") {
  throw new Error(`Expected package version 0.9.13, found ${pkg.version}`)
}
...
console.log(
  "Switch Vision SNMP2MQTT Core v0.9.13 shutdown-signal regression: PASS",
)
