...
if (pkg.version !== "0.9.12") {
  throw new Error(`Expected package version 0.9.12, found ${pkg.version}`)
}
...
console.log(
  "Switch Vision SNMP2MQTT Core v0.9.12 shutdown-signal regression: PASS",
)
